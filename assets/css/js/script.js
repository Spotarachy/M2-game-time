...
function game (){}  
let countEl = documrnt.getElementById("count-el")

console.log(couintEl)

let count = 0

function increment () {
    count = count + 1
    countEl.innerTrext =count
}
*/
...
<!-- Will have to see is this will work may need .function -->        
...
<!-- Beef here wiht the </style> form the one a the top -->
</style>
<!--   /\  may be in the worng place -->
